...
# 'curl' is a commandline HTTP request. We make an arbitrary post as if we had created a form.
...
# password_digest is the encryted password. We don't want to store the actual password,
# need to have a few layers of encryption
